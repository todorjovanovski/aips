...
public class Heroes {
    ...
    public static void startHeroesGame(SLL<Card> firstFriendCards, SLL<Card> secondFriendCards) {
        SLLNode<Card> maxDamageNode = firstFriendCards.getFirst();
        SLLNode<Card> temp1 = firstFriendCards.getFirst();
        SLLNode<Card> temp2 = secondFriendCards.getFirst();

        while(temp1 != null) {
            if(maxDamageNode.element.damage() < temp1.element.damage()) {
                maxDamageNode = temp1;
            }
            temp1= temp1.succ;
        }
        ...
        int n = secondFriendCards.size();
        for(int i=0; i<n/2; i++) {
            if(i == n/2 - 1) {
                secondFriendCards.insertAfter(maxDamageNode.element, temp2);
                firstFriendCards.delete(maxDamageNode);
            }
            temp2 = temp2.succ;
        }
    }
